	...
	return (
		<>
			<div className="card flex flex-col gap-2 w-[30em]">
				...
				<h1 className="text-2xl">I am some header text, make me big!</h1>

				{/* TODO 2: Change the <p> element below to change its text color to red */}
				<p className="text-2xl font-bold text-red-500">I want to be red</p>

				{/* TODO 3: Make the <div> below a rounded square box that is a shade of blue */}
				<div className="w-12 h-12 bg-blue-400 rounded-full shadow-green-400" />		
			</div>
